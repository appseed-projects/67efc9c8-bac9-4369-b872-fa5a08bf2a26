...
- 👉 [Soft UI Dashboard Django](https://django-datta-able.appseed-srv1.com/) - LIVE Demo
- 👉 [Soft UI Dashboard Django](https://django-soft-ui-dashboard.appseed-srv1.com/) - Product page

<br />

> Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/)
 
- Timestamp: `2022-06-01 16:41`
- Build ID: `67efc9c8-bac9-4369-b872-fa5a08bf2a26`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/67efc9c8-bac9-4369-b872-fa5a08bf2a26.git
$ cd 67efc9c8-bac9-4369-b872-fa5a08bf2a26
```
